...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'health_checks') THEN
...
BEGIN
    IF EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'health_checks') THEN
        IF NOT EXISTS (SELECT FROM pg_indexes WHERE schemaname = 'public' AND tablename = 'health_checks' AND indexname = 'health_checks_service_idx') THEN
            CREATE INDEX "health_checks_service_idx" ON "public"."health_checks"("service");
        END IF;
        IF NOT EXISTS (SELECT FROM pg_indexes WHERE schemaname = 'public' AND tablename = 'health_checks' AND indexname = 'health_checks_timestamp_idx') THEN
